...
DEFAULT_MODEL_PATH = 'models/go2/scene.xml'
DEFAULT_CONFIG_PATH = 'configs/mppi_gait_config_walk.yml'
DEFAULT_SIM_PATH = 'models/go2/scene.xml'
...
TASKS = {
    ...
    "big_box": {
        ...
        "waiting_times": [50,
                          ...
                          0, 
                          200],
        "model_path": 'models/go2/scene_big_box.xml',
        "config_path": 'configs/mppi_gait_config_big_box.yml',
        "sim_path": 'models/go2/scene_big_box.xml'
    },
    "stairs": {
        ...
        "model_path": 'models/go2/scene_stairs.xml',
        "config_path": 'configs/mppi_gait_config_stairs.yml',
        "sim_path": 'models/go2/scene_stairs.xml'
    },
    "stand": {
        "goal_pos": [[0, 0, 0.27]],
        "default_orientation": DEFAULT_ORIENTATION,
    ...
    "push_box": {
        ...
        "desired_gait": ['in_place', 
                         'walk'],
        "waiting_times": [None],
        "model_path": 'models/go2/scene_push_box.xml',
        "config_path": 'configs/mppi_gait_config_push_box.yml',
        "sim_path": 'models/go2/scene_push_box.xml'
    },
    "stand_hw": {
        "goal_pos": [[0, 0, 0.27]],
        "default_orientation": DEFAULT_ORIENTATION,
    ...
    "walk_straight_hw": {
        ...
        "desired_gait": ['in_place', 'walk_fast', 'in_place'],
        "waiting_times": [0, 0, 0],
        "model_path": DEFAULT_MODEL_PATH,
        "config_path": 'configs/mppi_gait_config_walk_hw.yml',
        "sim_path": DEFAULT_SIM_PATH
    ...
    "climb_box_hw": {
        ...
        "waiting_times": [50,
                          ...
                          0, 
                          200],
        "model_path": 'models/go2/scene_climb_box.xml',
        "config_path": 'configs/mppi_gait_config_climb_box_hw.yml',
        "sim_path": 'models/go2/scene_climb_box.xml'
    },
}
