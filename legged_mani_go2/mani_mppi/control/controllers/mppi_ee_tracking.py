"""Whole-body MPPI controller for Go2 + SO-ARM100 EE tracking."""
...
class MPPI(WholeBodyArmMPPI):
    ...
    def __init__(
        ...
        self.ee_site_name = self.task_data.get("ee_site", "end_effector")
    ...
    def quadruped_cost_np(self, x, u, x_ref):
        ...
        v_ref = x_ref[:, joint_velocity_start:joint_velocity_start + self.act_dim]
    ...
    def calculate_total_cost(
        ...
        if self.collision_enabled:
            ...
            clearance_rollouts = capsule_clearance.reshape(
                num_samples, horizon, len(self.collision_capsule_radii)
            )
        ...
        flat_states = self.canonical_robot_state(flat_states)
        ...
        flat_states[:, base_velocity_start:base_velocity_start + 3] = (
