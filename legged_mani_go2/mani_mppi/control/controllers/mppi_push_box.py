"""CEM-guided whole-body MPPI controller for Go2 box pushing."""
...
class MPPI(CEMWholeBodyArmMPPI):
    ...
    def __init__(
        ...
        if (
            ...
            raise ValueError(
                "Expected Go2 + SO-ARM100 robot state dimensions 23 + 22"
            )
    ...
    def calculate_total_cost(
        ...
        flat_robot_states = self.canonical_robot_state(
            flat_robot_states,
            robot_qpos_indices=self.robot_qpos_indices,
            robot_dof_indices=self.robot_dof_indices,
        )
        ...
        flat_robot_states[:, base_velocity_start:base_velocity_start + 3] = (
            batch_world_to_local_velocity(
                ...
                flat_robot_states[
                    :, base_velocity_start:base_velocity_start + 3
                ],
            )
        )
