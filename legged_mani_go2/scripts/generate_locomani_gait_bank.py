...
32-row Go2 + SO-ARM100 layout expected by the whole-body controllers.
"""
...
OUTPUT_ROOT = GAITS_DIR / "FAST/go2_so_arm_height_conditioned"
PHASE_LENGTH = 100
...
def generate() -> list[Path]:
    ...
    for base_height, step_height, directory in HEIGHT_LEVELS:
        ...
        write_reference(
            ...
            stance,
            (
                "Go2 + SO-ARM100 four-foot stance hold; "
